...
using Functionland.FxFiles.Api.Models.Emailing;

namespace Functionland.FxFiles.Api.Controllers;
...
public partial class AuthController : AppControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Functionland.FxFiles.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Functionland.FxFiles.Api.Resources.ResetPassword.cshtml",
