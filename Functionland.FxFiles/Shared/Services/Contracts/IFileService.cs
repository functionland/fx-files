...
namespace Functionland.FxFiles.Shared.Services.Contracts
{
    public interface IFileService
    {
        ...
        Task MoveArtifactsAsync(FsArtifact[] artifacts, string destination, bool beOverWritten = false, CancellationToken? cancellationToken = null);
        Task CopyArtifactsAsync(FsArtifact[] artifacts, string destination, bool beOverWritten = false, CancellationToken? cancellationToken = null);
