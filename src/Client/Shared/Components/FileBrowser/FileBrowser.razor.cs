...
public partial class FileBrowser : IDisposable
{
    ...
    private bool _isPinBoxLoading = false;
    ...
    {
        get { return _artifactExplorerMode; }
        set
        {
