...
public interface IZipService
{
    ...
    Task ExtractZippedArtifactAsync(string zipFullPath, string destinationPath, List<string> itemsPath, bool overwrite = false, string? password = null, CancellationToken? cancellationToken = null);
}
