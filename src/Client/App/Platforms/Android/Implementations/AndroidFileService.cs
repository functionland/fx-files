...
public partial class AndroidFileService : LocalDeviceFileService
{
    ...
    public override async Task MoveArtifactsAsync(IEnumerable<FsArtifact> artifacts, string destination, bool overwrite = false, Action<ProgressInfo>? onProgress = null, CancellationToken? cancellationToken = null)
    {
        if (!PermissionUtils.CheckStoragePermission())
        {
            PermissionUtils.RequestStoragePermission();
    ...
    public override async Task CopyArtifactsAsync(IEnumerable<FsArtifact> artifacts, string destination, bool overwrite = false, Action<ProgressInfo>? onProgress = null, CancellationToken? cancellationToken = null)
    {
        if (!PermissionUtils.CheckStoragePermission())
        {
            PermissionUtils.RequestStoragePermission();
    ...
    public override async Task DeleteArtifactsAsync(IEnumerable<FsArtifact> artifacts, Action<ProgressInfo>? onProgress = null, CancellationToken? cancellationToken = null)
    {
        if (!PermissionUtils.CheckStoragePermission())
        {
            PermissionUtils.RequestStoragePermission();
