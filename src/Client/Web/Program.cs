...
namespace Functionland.FxFiles.Client.Web;
...
public class Program
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("Functionland.FxFiles.Client.Shared.wwwroot.appsettings.json"));
